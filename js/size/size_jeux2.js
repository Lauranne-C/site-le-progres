...
page.style.height = (window.innerHeight) - (menu.offsetHeight) + "px";


menu.style.height = ((hauteur/100)*7) + "px"; 
menu.style.width = ((largeur - 15) + "px");
list.style.padding.top = (menu.offsetHeight/2) - 10 + "px";


foot.style.height = ((hauteur/100)*10) + "px";
foot.style.width = ((largeur - 15) + "px");
para_foot.style.padding.top = (foot.offsetHeight/2) - 8 + "px";
barre.style.margin.top = (foot.offsetHeight/2) + "px";
