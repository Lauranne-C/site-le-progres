...
foot.style.top = hauteur + foot.offsetHeight+ "px"

title.style.width = largeur - 20 + "px";
page.style.height = (window.innerHeight) + foot.offsetHeight + menu.offsetHeight  + "px";
...
foot.style.width = largeur - 20 +"px";
foot.style.height = (hauteur/100)*10 +"px";
foot_para.style.padding.top = (foot.offsetHeight/2) - 16 + "px";
